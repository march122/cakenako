	...
	<div class="row">
		...
		<div class="col-12">
			<div class="form-group button">
				<!-- Button that triggers the email script -->
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								...
								<div class="single-info">
									...
									<ul>
										<li><a href="mailto:info@sweetcakes.com">info@sweetcakes.com</a></li>
										<li><a href="mailto:info@sweetcakes.com">support@sweetcakes.com</a></li>
									</ul>
								</div>
								<div class="single-info">
